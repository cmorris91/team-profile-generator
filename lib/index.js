...
const genManager = require('../lib/generateteam');
const genEngineer = require('../lib/generateteam');
const genIntern = require('../lib/generateteam');
const Footer = require('../lib/generateteam');
