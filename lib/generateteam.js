...
//         html +=  `<div class="employee col-12 col-lg-4">
//         <div class="card-body">
//         <h3 class="name">${name}</h3>
//         <h4 class="role">${role}</h4>
//         </div>
//         <ul class="info" style="list-style-type: none;">
//         <li><a href="mailto: ${email}"><i class="fas fa-envelope">  ${email}</i></a></li>
//         <li>${id}</li>
//         </ul>
//         </div>`

//         if(role=== 'Manager') {
//             let office = team[i].getOfficeNumber();
//             html += `<li>${office}</li>`
//         }
//         else if (role === 'Engineer') {
//             let github = team[i].getGithub();
//             html += `<li><a href ="https://github.com/${github}">Github: github.com/${github}</a></li>`
//         }
//         else {
...
function getHTML() {
   ...
   generateTeam();
    ...
    const generateTeam = htmlPageContent
